			...
			<div class="col-md-7">
				...
				<?php $no = 1; foreach ($data as $nilai): ?>
					<form name="formNilai" method="post" action="<?php if($key == 'input'){echo base_url('index.php/Controller_nilai/simpanNilaiSiswa');} else{echo base_url('index.php/Controller_nilai/ubahNilaiSiswa');}  ?>">					
							...
							<input type="" id="tugas1" name="tugas1" class="form-control" <?php if($key == 'input' && $nilai->tugas1 > 0){echo " readonly=\"\"value=\" $nilai->tugas1 \"";} else{echo "value=\" $nilai->tugas1 \"";} ?>>
							<input type="" id="tugas2" name="tugas2" class="form-control" style="margin-top: 15px " <?php if($key == 'input' && $nilai->tugas2 > 0){echo " readonly=\"\" value=\" $nilai->tugas2 \"";} else{ echo " value=\" $nilai->tugas2 \""; } ?>>
							<input type="" id="uts" name="uts" class="form-control" style="margin-top: 15px" <?php if($key == 'input' && $nilai->uts > 0){echo " readonly=\"\" value=\" $nilai->uts \"";} else{ echo " value=\" $nilai->uts \""; } ?>>
							<input type="" id="uas" name="uas" class="form-control" style="margin-top: 15px" <?php if($key == 'input' && $nilai->uas > 0){echo " readonly=\"\" value=\" $nilai->uas \"";} else{ echo " value=\" $nilai->uas \""; } ?>>	
							<div class="col-md-6">
