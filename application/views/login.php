...
<div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-4" style="background-color: grey; margin-top: 95px; margin-bottom: 175px; background:rgba(0,0,0,0.5;">
        ...
        <form class="form-horizontal" >
          <div class="form-group" style="margin-top: 5px; ">
            ...
            <label>NISN : </label>
              <input type="" class="form-control" id="NISN" placeholder="Masukkan NISN">
            </div>
          </div>
